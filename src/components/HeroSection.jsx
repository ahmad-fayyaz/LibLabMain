...
const HeroSection = () => {
  ...
  return (
    <div className="transition flex-col items-start mt-20 px-6 mb-20">
      <div className="transition w-full max-w-screen-lg mx-auto p-6 lg:w-[820px] lg:h-auto">
        ...
        <div className="transition flex flex-auto w-full mt-10 justify-center lg:ml-40 lg:justify-start">
          <button
